...
# This file is a simple Python test program using the src code to display custom content on screen (see README)
...
if __name__ == "__main__":
    ...
    lcd_comm.display_bitmap(background)
